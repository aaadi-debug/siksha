  ...
  return (
    <nav
      className={`navbar navbar-expand-lg ${
        scrolled ? "navbar_fixed navbar_dark" : ""
      }`}
    >
          ...
          <ul className="navbar-nav ms-auto">
            <li className="nav-item">
              <Link
                ...
                style={{
                  color: activeItem === "item1" ? "#fff" : "",
                  background: activeItem === "item1" ? "#3D52A0" : "",
                }}
              >
                Home
              </Link>
            ...
            <li className="nav-item">
              <Link
                ...
                style={{
                  color: activeItem === "item2" ? "#fff" : "",
                  background: activeItem === "item2" ? "#3D52A0" : "",
                }}
              >
                Siksha H.
              </Link>
            ...
            <li className="nav-item">
              <Link
                ...
                style={{
                  color: activeItem === "item3" ? "#fff" : "",
                  background: activeItem === "item3" ? "#3D52A0" : "",
                }}
              >
                About
              </Link>
            ...
            <li className="nav-item">
              <Link
                ...
                style={{
                  color: activeItem === "item4" ? "#fff" : "",
                  background: activeItem === "item4" ? "#3D52A0" : "",
                }}
              >
                Contact
              </Link>
            ...
            <li className="nav-item dropdown">
              <a
                ...
                style={{
                  color: activeItem === "item5" ? "#fff" : "",
                  background: activeItem === "item5" ? "#3D52A0" : "",
                }}
              >
                Colleges
              </a>
              <ul className="dropdown_menu dropdown_menu--animated dropdown_menu-6">
                <li className="dropdown_item-1 truncate ">
                  <Link href="/collegepage/IIT Delhi (IIT-D)">IIT Delhi</Link>
                </li>
                <li className="truncate">
                  <Link href="/collegepage/IIT Madras (IIT-M)">IIT Madras</Link>
                </li>
                <li className="truncate">
                  <Link href="/collegepage/IIT Kharagpur (IIT-KGP)">
                    IIT Kharagpur
                  </Link>
                </li>
                <li className="truncate">
                  <Link href="/collegepage/IIT Roorkee (IIT-R)">
                    IIT Roorkee
                  </Link>
                </li>
                <li className="truncate">
                  <Link href="/collegepage/IIT Bombay (IIT-B)">IIT Bombay</Link>
                </li>
                ...
                <div className="noti_content mt-3">
                  ...
                  <div className="notifications mt-3">
                    {notifications
                      ...
                      .map((notification) => (
                        <div
                          className="nav_notification_div"
                          key={notification.id}
                        >
                          <div className="d-flex align-items-start">
                            <img src={notification.image} alt="" />
                            <div className="nav_notification_title ml-2">
                              {notification.title || "N/A"}
                            </div>
                          </div>
                          <p className="nav_notification_para">
                            {notification.message || "N/A"}
                          </p>
                          <div className="d-flex justify-content-between">
                            <div className="nav_noti_date">
                              {new Date(notification.date).toLocaleDateString()}
                            </div>
                            <button
                              className="nav_noti_readMore"
