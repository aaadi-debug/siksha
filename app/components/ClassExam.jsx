        ...
        <div className="classexam_wrapper container lg:px-32">
            ...
            <div className="row">
                <div className="col-md-6">
                    <h6 data-aos="fade-up" className='second_div_margin_top font-medium mb-2'>CBSE Class 10th Board Exam</h6>
                ...
                <div className="col-md-6">
                    <h6 data-aos="fade-up" className='second_div_margin_top font-medium mb-2'>CBSE Class 12th Board Exam</h6>
                    <div className="classexam_body">
                        <div className="double_widget">
                            <div className="classexam_widget">
                                <div data-aos="fade-up" className="classexam_widget_icon"> 
