        ...
        <>
            <div className="about_us">
                ...
                <div className="about_long_way py-4 my-5">
                    <h3 data-aos="fade-up" className='text-center text-3xl font-semibold'>Our Milestones</h3>
                    ...
                    <div className="team_img">
                        <h3 data-aos="fade-up" className='text-3xl font-semibold mb-2'>Why Choose Siksha Helpline?</h3>
                    ...
                    <div className="bg_reddish about_advertise py-5">
                        <div className="container lg:px-32">
                            <h3 data-aos="fade-up" className='text-3xl font-semibold'>Contact With Us</h3>
                            <p data-aos="fade-up" className='my-4'>"Ready to embark on your educational journey? Contact the Siksha Helpline today for personalized admission guidance.
